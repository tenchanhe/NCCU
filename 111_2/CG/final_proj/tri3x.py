...
def get_speed(body, x, y):
	...
	if abs(speed_dis_x) < 0.15:
		speed_dis_x = 0
	if abs(speed_dis_y) < 0.15:
		speed_dis_y = 0
...
rectangle_body = world.CreateDynamicBody(position=(25, 30), angle= math.radians(60))
