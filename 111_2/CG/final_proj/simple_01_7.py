...
def effect_on(x, y):
	...
	t3[1][0] = t1[1][0] + (t2[1][0] - t1[1][0]) * x / k
	...
	for body in (ground_body, rectangle_body, rectangle_body2):  # or: world.bodies
		...
		for fixture in body.fixtures:
			...
			if body.type == 2:
				...
				speed = get_speed(body, last_speed_x, last_speed_y)
				last_speed_x = speed[2]
				last_speed_y = speed[3]
				transformed_vertices = []
				extend_shape = expand_rectangle(start_shape, 4)
				effect_on(speed[0], speed[1])
