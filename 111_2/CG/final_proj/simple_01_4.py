...
#	y = 10
	...
	Q3[0][1] = Q1[0][1] + (Q2[0][1] - Q1[0][1]) * y / k
...
dynamic_body = world.CreateDynamicBody(position=(10, 40), angle=15)
	...
	for body in (ground_body, dynamic_body):  # or: world.bodies
		...
		for fixture in body.fixtures:
			...
			if body.type == 2:
				...
				speed_dis_x = abs(now_speed_x**2 - last_speed_x**2)
...
#				print(speed_dis_x, speed_dis_y)
				...
				for v in extend_shape:
					...
					transformed_point = [
#						A2[0][0] * x + A2[0][1] * y + Q2[0][0] * x2 + Q2[0][1] * y2 + m2[0][0] * xy + t2[0][0],
#						A2[1][0] * x + A2[1][1] * y + Q2[1][0] * x2 + Q2[1][1] * y2 + m2[1][0] * xy + t2[1][0],
