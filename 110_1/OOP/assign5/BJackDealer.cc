...
BJackDealer::BJackDealer(const char *player_name,int nSet):BJackPlayer(player_name){ //Initialization 
...
BJackDealer::judge(int oppTotal) const {
    ...
    int myTotal = totalPoints();//dealer.totalPoints();
...
void
BJackDealer::dealer_start(void) {  //change the name of this function for using the fucntion in BJPlayer
